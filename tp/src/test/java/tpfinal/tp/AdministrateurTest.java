...
public class AdministrateurTest {
	    ...
	    public void achetermateriel() {
	    	((Administrateur) admin).achetermateriel(e6);
	        int stockEntreprise = ((Administrateur) admin).stockEntreprise().size();
	        Assert.assertEquals("materiel acheté: fail",1,stockEntreprise);
	    }
	    ...
	    public void supprimerMaterielDefectueuxEntreprise_sansMaterielDefectueux() {
	        ...
	        ((Administrateur) admin).supprimerMaterielDefectueuxEntreprise(e);
